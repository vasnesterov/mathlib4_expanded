...
theorem hom_chart (y₀ y : LE₁E₂) :
  ...
  rw [FiberBundle.chartedSpace_chartAt]; rw [trans_apply]; rw [LocalHomeomorph.prod_apply]; rw [Trivialization.coe_coe]; rw [LocalHomeomorph.refl_apply]; rw [Function.id_def]; rw [hom_trivializationAt_apply]
