...
theorem Complex.subfield_eq_of_closed {K : Subfield ℂ} (hc : IsClosed (K : Set ℂ)) :
  ...
  suffices range (ofReal' : ℝ → ℂ) ⊆ K by
    rw [range_subset_iff] at this; rw [← coe_algebraMap] at this
    have :=
  ...
  · -- extψ : closure(K) →+* ℂ is the extension of ψ : K →+* ℂ
    ...
    · left
      ...
      · have :=
        ...
        rw [RingHom.comp_apply] at this; rw [RingHom.comp_apply] at this; rw [hr] at this; rw [RingEquiv.toRingHom_eq_coe] at this
