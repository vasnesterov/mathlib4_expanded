...
theorem continuousOn_continuousLinearMapCoordChange [VectorBundle 𝕜₁ F₁ E₁] [VectorBundle 𝕜₂ F₂ E₂]
  ...
  · intro b _; ext L v
    -- Porting note: was
    -- simp only [continuousLinearMapCoordChange, ContinuousLinearEquiv.coe_coe, --   ContinuousLinearEquiv.arrowCongrₛₗ_apply, LinearEquiv.toFun_eq_coe, coe_comp', --   ContinuousLinearEquiv.arrowCongrSL_apply, comp_apply, Function.comp, compSL_apply, --   flip_apply, ContinuousLinearEquiv.symm_symm]
...
theorem continuousLinearMapCoordChange_apply (b : B)
  ...
  rw [e₂.coordChangeL_apply e₂']; rw [e₁'.coordChangeL_apply e₁]; rw [e₁.coe_linearMapAt_of_mem hb.1.1]; rw [e₂'.coe_linearMapAt_of_mem hb.2.2]
